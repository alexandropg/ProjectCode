...
public class CustomerFormFirm extends javax.swing.JFrame {
    public CustomerFormFirm() 
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Επωνυμία Πελάτη");
        ...
        jLabel11.setText("Καταχώριση Πελάτη Χονδρικής");
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerFormFirm().setVisible(true);
            }
        });
    }
